...
class TmxEntity extends Entity
{
	...
	public function loadGraphic(tileset:Dynamic, layerNames:Array<String>, skip:Array<Int> = null)
	{
		...
		// the following is the only ugly thing. sort of.		
#if flash
			var _tileset = openfl.Assets.getBitmapData(Std.string("gfx/" + tileset));
#else
			var _tileset = new com.haxepunk.graphics.atlas.TileAtlas(Std.string("gfx/"+tileset), map.tileWidth, map.tileHeight, spacing, spacing);
#end
